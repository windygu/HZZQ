...
namespace App.View.Param
{
    public class Parameter: BaseObject
    {
        ...
        [CategoryAttribute("连接仓库输送线PLC通信参数"), DescriptionAttribute("服务名称"), Chinese("服务名称")]
        ...
        [CategoryAttribute("连接仓库输送线PLC通信参数"), DescriptionAttribute("服务地址IP"), Chinese("服务IP")]
        ...
        [CategoryAttribute("连接仓库输送线PLC通信参数"), DescriptionAttribute("连接仓库输送线通讯连接名称"), Chinese("连接名称")]
        ...
        [CategoryAttribute("连接仓库输送线PLC通信参数"), DescriptionAttribute("连接仓库输送线刷新频率"), Chinese("刷新频率")]
        ...
        [CategoryAttribute("老线输送线PLC通信参数"), DescriptionAttribute("服务名称"), Chinese("服务名称")]
        ...
        [CategoryAttribute("老线输送线PLC通信参数"), DescriptionAttribute("服务地址IP"), Chinese("服务IP")]
        ...
        [CategoryAttribute("老线输送线PLC通信参数"), DescriptionAttribute("老线输送线PLC通讯连接名称"), Chinese("连接名称")]
        ...
        [CategoryAttribute("老线输送线PLC通信参数"), DescriptionAttribute("老线输送线PLC刷新频率"), Chinese("刷新频率")]
